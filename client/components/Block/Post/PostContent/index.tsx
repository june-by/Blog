...
import useHandleTopicPosition from "../../../../Hooks/useHandleTopicPosition";
		...
		<div className={styles.PostContent}>
			...
			<div className={styles.TopicWrapper}>
				<div className={styles.TopicWrapper_second} ref={topicRef}>
					{topicArr?.length !== 0 && topicArr.map((topic: any, idx: number) => {
						return <div key={idx + 100} onClick={gotoTopic(topic)}>{topic?.innerText}</div>
					})}
				</div>
			</div>
		</div>
