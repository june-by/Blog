---
title: "React.cloneElement API를 활용해 서버 컴포넌트의 클라이언트 로직 분리하기"
date: "2024-02-18"
lastmod: "2024-02-18"
category: "React"
tags: ["rsc", "cloneElement"]
...
<div align="right">
  [![Hits](https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fbyjuun.com%2Fposts%2FReact%2Fseparate-server-component-client-logic&count_bg=%233B82F6&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=views&edge_flat=false)](https://hits.seeyoufarm.com)
</div>
...
const CategoryButton = ({ category: { text, count }, isCurrentSelectedCategory }: Props) => {
