...
const getAllSeries = () => __awaiter(void 0, void 0, void 0, function* () {
    const series = yield database_1.Series.findAll({
        order: constants_1.ORDER_BY_CREATED_AT,
        include: [{ model: database_1.Posts, attributes: ["id", "title"] }],
    });
    return series;
});
const getSeriesIdByTitle = ({ title, }) => __awaiter(void 0, void 0, void 0, function* () {
    const series = yield database_1.Series.findOne({
        where: { title },
    });
...
const addSeries = (seriesCreationAttribute) => __awaiter(void 0, void 0, void 0, function* () {
    const series = yield database_1.Series.create(seriesCreationAttribute);
    return series;
});
exports.default = {
    getAllSeries,
