...
const getPost = ({ id }) => __awaiter(void 0, void 0, void 0, function* () {
    const post = yield _database_1.Posts.findOne({ where: { id } });
    return post;
});
const getFullPost = ({ id }) => __awaiter(void 0, void 0, void 0, function* () {
    const fullPost = yield _database_1.Posts.findOne({
        where: { id },
        attributes: {
            exclude: ["updatedAt"],
        },
...
const createPost = (postCreationAttributes) => __awaiter(void 0, void 0, void 0, function* () {
    const post = yield _database_1.Posts.create(Object.assign(Object.assign({}, postCreationAttributes), { views: 0 }));
    return post;
});
const updatePost = ({ title, category, content, thumbNailUrl, shortDescription, SeriesId, id, isPublic, }) => __awaiter(void 0, void 0, void 0, function* () {
    yield _database_1.Posts.update({
        title,
        category,
        content,
        thumbNailUrl,
...
const deletePost = ({ id }) => __awaiter(void 0, void 0, void 0, function* () {
    yield _database_1.Posts.destroy({
        where: { id },
    });
});
...
const getViewCount = ({ id, }) => __awaiter(void 0, void 0, void 0, function* () {
    const viewCount = yield _database_1.Posts.findOne({
        where: { id },
        attributes: ["views"],
    });
    return viewCount;
...
const getPrevPost = ({ category, id, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [prev, _] = yield _database_1.sequelizeConnection.query(query, {
...
const getNextPost = ({ category, id, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [next, _] = yield _database_1.sequelizeConnection.query(query, {
        replacements: [category, id],
    });
    return next[0];
});
