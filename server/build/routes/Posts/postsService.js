...
const getAllPostsId = () => __awaiter(void 0, void 0, void 0, function* () {
    const posts = yield _database_1.Posts.findAll({
        attributes: ["id"],
    });
    return posts;
});
...
const getPostsBySeriesId = ({ page, SeriesId, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const fieldForPagedQuery = isPagedRequest
        ...
        : {};
    const posts = yield _database_1.Posts.findAll(Object.assign(Object.assign({ where: { SeriesId } }, fieldForPagedQuery), { attributes: {
            exclude: DEFAULT_EXCLUDE_COLUMN,
        }, include: [
            {
                model: _database_1.Tags,
...
const getCategoryPostsCount = () => __awaiter(void 0, void 0, void 0, function* () {
    const categoryCount = yield _database_1.Posts.findAll({
        attributes: [
            "category",
            [
                _database_1.sequelizeConnection.fn("COUNT", sequelize_1.default.col("Posts.category")),
                "count",
            ],
        ],
...
const getPostsCount = ({ category }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [data, _] = yield _database_1.sequelizeConnection.query(query);
    return data[0].count;
});
