...
router.post("/edit/:snippetId", _middleware_1.isAdmin, (0, _middleware_1.cacheClearMiddleWare)("snippet"), snippetController_1.default.updateSnippet);
router.post("/delete/:snippetId", _middleware_1.isAdmin, (0, _middleware_1.cacheClearMiddleWare)("snippet"), snippetController_1.default.deleteSnippet);
