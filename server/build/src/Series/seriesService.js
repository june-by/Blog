...
const getAllSeries = () => __awaiter(void 0, void 0, void 0, function* () {
    const series = yield models_1.Series.findAll({
        order: constants_1.ORDER_BY_CREATED_AT,
        include: [{ model: models_1.Posts, attributes: ["id", "title"] }],
    });
    return series;
});
...
const addSeries = (seriesCreationAttribute) => __awaiter(void 0, void 0, void 0, function* () {
    const series = yield models_1.Series.create(seriesCreationAttribute);
    return series;
});
exports.default = {
    getAllSeries,
