    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            postService_1.default.createPost({
              title: title,
              category: category,
              content: content,
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            tagService_1.default.createTags({ tagArr: tagArr }),
          ];
        case 2:
          result = _b.sent();
          return [
            4 /*yield*/,
            postService_1.default.addTags({ post: post, result: result }),
          ];
        case 3:
          _b.sent();
          _b.label = 4;
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            postService_1.default.deletePost({ postId: postId }),
          ];
        case 1:
          _a.sent();
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            commentService_1.default.addComment({
              postId: postId,
              comment: comment,
              userId: id,
            }),
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            commentService_1.default.getComment(newComment.id),
          ];
        case 3:
          fullComment = _a.sent();
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            postService_1.default.updatePost({
              title: title,
              category: category,
              content: content,
              thumbNailUrl: thumbNailUrl,
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            postService_1.default.getPost({ postId: postId }),
          ];
        case 3:
          post = _b.sent();
          return [
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            postService_1.default.updateTags({ post: post, result: result }),
          ];
        case 5:
          _b.sent();
          return [
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            postService_1.default.getFullPost({ postId: postId }),
          ];
        case 2:
          mainPost = _a.sent();
          if (!mainPost)
          ...
          return [
            4 /*yield*/,
            postService_1.default.getPrevPost(mainPost.category, postId),
          ];
        case 3:
          prevPost = _a.sent();
          return [
            4 /*yield*/,
            postService_1.default.getNextPost(mainPost.category, postId),
          ];
        case 4:
          nextPost = _a.sent();
          res
          ...
          postService_1.default.addViewCount({
            postId: postId,
