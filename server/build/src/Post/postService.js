...
const getPost = ({ id }) => __awaiter(void 0, void 0, void 0, function* () {
    const post = yield models_1.Posts.findOne({ where: { id } });
    return post;
});
const getFullPost = ({ id }) => __awaiter(void 0, void 0, void 0, function* () {
    const fullPost = yield models_1.Posts.findOne({
        where: { id },
        attributes: {
            exclude: ["updatedAt"],
        },
...
const createPost = (postCreationAttributes) => __awaiter(void 0, void 0, void 0, function* () {
    const post = yield models_1.Posts.create(Object.assign(Object.assign({}, postCreationAttributes), { views: 0 }));
    return post;
});
...
const getViewCount = ({ id, }) => __awaiter(void 0, void 0, void 0, function* () {
    const viewCount = yield models_1.Posts.findOne({
        where: { id },
        attributes: ["views"],
    });
    return viewCount;
...
const getPrevPost = ({ category, id, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [prev, _] = yield models_1.sequelizeConnection.query(query, {
...
const getNextPost = ({ category, id, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [next, _] = yield models_1.sequelizeConnection.query(query, {
        replacements: [category, id],
    });
    return next[0];
});
