...
var getCategoryPostsCount = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var categoryCount;
          ...
          return [
            ...
            Post.findAll({
              attributes: [
                "category",
                [
                  sequelize_1.default.fn(
                    "COUNT",
                    sequelize_1.default.col("Post.category")
                  ),
                  "count",
                ],
              ],
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          where =
            category === "main" ? "" : 'where category="'.concat(category, '"');
